...
program. Then the laserscanner reads the gob'ed data during initialization \ref{fig:loadpoints}.
...
\subsection{Result}
The most useful feature of Go, for the laser scanner, is its Gob library for point serialization.
The laser scanner took no user input or external event input. It is not a very complicated program

Gob made it so
that the most difficult part of the laser projector
