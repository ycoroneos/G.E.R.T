cmd_board/wandboard/wandboard.o := arm-none-eabi-gcc -Wp,-MD,board/wandboard/.wandboard.o.d  -nostdinc -isystem /usr/lib/gcc/arm-none-eabi/5.4.0/include -Iinclude    -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x17800000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -D__ARM__ -Wa,-mimplicit-it=always -mthumb -mthumb-interwork -mabi=aapcs-linux -mword-relocations -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(wandboard)"  -D"KBUILD_MODNAME=KBUILD_STR(wandboard)" -c -o board/wandboard/wandboard.o board/wandboard/wandboard.c

source_board/wandboard/wandboard.o := board/wandboard/wandboard.c

deps_board/wandboard/wandboard.o := \
...
board/wandboard/wandboard.o: $(deps_board/wandboard/wandboard.o)
