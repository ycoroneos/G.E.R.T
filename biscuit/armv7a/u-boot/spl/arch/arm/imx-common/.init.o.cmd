cmd_spl/arch/arm/imx-common/init.o := arm-none-eabi-gcc -Wp,-MD,spl/arch/arm/imx-common/.init.o.d  -nostdinc -isystem /usr/lib/gcc/arm-none-eabi/5.4.0/include -Iinclude    -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x17800000 -DCONFIG_SPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -ffunction-sections -fdata-sections -D__ARM__ -Wa,-mimplicit-it=always -mthumb -mthumb-interwork -mabi=aapcs-linux -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(init)"  -D"KBUILD_MODNAME=KBUILD_STR(init)" -c -o spl/arch/arm/imx-common/init.o arch/arm/imx-common/init.c

source_spl/arch/arm/imx-common/init.o := arch/arm/imx-common/init.c

deps_spl/arch/arm/imx-common/init.o := \
...
spl/arch/arm/imx-common/init.o: $(deps_spl/arch/arm/imx-common/init.o)
